...
public class AttrController {
    ...
    @GetMapping
    public Resp<PageVo> queryAttrByCid(QueryCondition condition,@RequestParam("cid")Long cid,@RequestParam(value = "type",defaultValue = "1")Integer type){
        PageVo page=attrService.queryAttrByCid(condition,cid,type);
        return Resp.ok(page);
    }
