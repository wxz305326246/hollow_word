...
public class AttrAttrgroupRelationController {
    ...
    public Resp<Object> deleteRelation(@RequestBody List<AttrAttrgroupRelationEntity> attrgroupRelationEntities){
        this.attrAttrgroupRelationService.deleteRelation(attrgroupRelationEntities);
        return Resp.ok(null);
    }
