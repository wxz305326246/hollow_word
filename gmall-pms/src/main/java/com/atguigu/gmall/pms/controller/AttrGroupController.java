...
public class AttrGroupController {
    ...
    public Resp<List<GroupVO>> queryGroupWithAttrsByCid(@PathVariable("catId")Long catId){
        List<GroupVO> attrVOList=this.attrGroupService.queryGroupWithAttrsByCid(catId);
        return Resp.ok(attrVOList);
    }
